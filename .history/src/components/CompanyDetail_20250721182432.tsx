...
export default function CompanyDetail({ companyId }: { companyId: string }) {
  ...
  <div className="space-y-8">
    ...
    <div className="bg-white border border-gray-200 rounded-lg p-6 space-y-6">
      <div className="flex justify-between items-start flex-col md:flex-row md:items-center">
        <div className="flex items-start gap-4">
          {editMode ? (
            <div className="h-20 w-20 border border-gray-300 rounded-lg flex items-center justify-center text-sm text-gray-500">
            ...
            <div className="relative h-20 w-20">
              ...
              />
              <div className="hidden h-20 w-20 items-center justify-center bg-gray-100 rounded-lg">
          ...
          <div>
            {editMode ? (
              <input
                ...
                className="text-3xl font-bold border-b border-gray-300 focus:outline-none focus:border-blue-500 text-gray-800"
              />
            ) : (
            ...
            {editMode ? (
              <textarea
                ...
                onChange={handleChange}
                rows={3}
                className="mt-4 w-full border border-gray-300 rounded-lg p-2 text-gray-700 focus:ring-blue-500"
              />
            ) : (
    ...
    <div className="space-y-4">
      <h2 className="text-2xl font-bold text-gray-800">Open Roles</h2>
      {jobs.length === 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {jobs.map((job) => (
            <div
              ...
              className="cursor-pointer bg-white border border-gray-200 rounded-lg p-4 hover:shadow transition-shadow"
            >
